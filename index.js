...
function processSum(numberList, callback) {
  let total = numberList.reduce((accumulator, currentValue) => {
...
function firstNamesAllCaps(runners) {
  let runnerFirstNames = []
  runners.map(runner => {
    // console.log(runner.first_name.toUpperCase())
    runnerFirstNames.push(runner.first_name.toUpperCase())
  });
...
function tallyUpDonations(runners) {
  let totalDonations = runners.reduce(function(acc, current) {
